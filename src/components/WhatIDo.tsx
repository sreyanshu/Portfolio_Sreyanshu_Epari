        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Specializing in incident response, network monitoring, and applying AI-based solutions to mitigate risks and secure corporate environments.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Autopsy</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Building predictive models and analyzing datasets to derive actionable insights, optimize processes, and enhance real-time detection systems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
